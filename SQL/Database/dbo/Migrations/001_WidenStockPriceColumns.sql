...
UPDATE [dbo].[Stocks]
SET
    [Price]     = CASE WHEN [Price]     > 9999.99 THEN 9999.99 ELSE [Price]     END,
    [PrevPrice] = CASE WHEN [PrevPrice] > 9999.99 THEN 9999.99 ELSE [PrevPrice] END,
    [High24h]   = CASE WHEN [High24h]   > 9999.99 THEN 9999.99 ELSE [High24h]   END,
    [Low24h]    = CASE WHEN [Low24h]    > 9999.99 THEN 9999.99 ELSE [Low24h]    END
WHERE
    [Price] > 9999.99
    OR [PrevPrice] > 9999.99
    OR [High24h]   > 9999.99
    OR [Low24h]    > 9999.99;
GO
