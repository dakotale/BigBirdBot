...
/// expanded to cover every remaining stored-procedure-backed table.
///
/// The bot's SQL Server database already exists and is managed outside EF Core (SSMS
/// scripts + hand-written migration files under <c>SQL/Database</c>), so there are
/// <b>no EF migrations</b> — every entity is mapped explicitly to its existing table and
/// columns here.
///
...
public sealed class BigBirdContext(DbContextOptions<BigBirdContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>(e =>
        {
            ...
            e.Property(x => x.JoinDate).HasColumnName("JoinDate").HasColumnType("datetime");
            ...
            e.Property(x => x.CreatedOn).HasColumnName("CreatedOn").HasColumnType("datetime");
            e.Property(x => x.DeletedOn).HasColumnName("DeletedOn").HasColumnType("datetime");
            e.Property(x => x.LastSeen).HasColumnName("LastSeen").HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<AuditButtonExecuted>(e =>
        {
            ...
            e.Property(x => x.ServerUid).HasColumnName("ServerUID");
            e.Property(x => x.ExecutedOn).HasColumnName("ExecutedOn").HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<AuditGuildJoined>(e =>
        {
            ...
            e.Property(x => x.JoinedOn).HasColumnName("JoinedOn").HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<AuditReactionAdded>(e =>
        {
            ...
            e.Property(x => x.AddedOn).HasColumnName("AddedOn").HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<AuditUserLeft>(e =>
        {
            ...
            e.Property(x => x.UserUid).HasColumnName("UserUID");
            e.Property(x => x.ServerUid).HasColumnName("ServerUID");
            e.Property(x => x.LeftOn).HasColumnName("LeftOn").HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<AuditGameTrigger>(e =>
        {
            ...
            e.Property(x => x.UserUid).HasColumnName("UserUID");
            e.Property(x => x.ServerUid).HasColumnName("ServerUID");
            e.Property(x => x.TriggeredOn).HasColumnName("TriggeredOn").HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<Reminder>(e =>
        {
            ...
            e.Property(x => x.RemindAtUtc).HasColumnName("RemindAtUtc").HasColumnType("datetime");
        ...
        modelBuilder.Entity<Birthday>(e =>
        {
            ...
            e.Property(x => x.BirthdayDate).HasColumnName("BirthdayDate").HasColumnType("datetime");
        ...
        modelBuilder.Entity<PetWordPuzzle>(e =>
        {
            ...
            e.Property(x => x.ExpiresAt).HasColumnName("ExpiresAt").HasColumnType("datetime");
